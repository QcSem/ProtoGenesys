...
namespace ProtoGenesys
{
	...
	bool cProfiler::SaveProfile(const std::string& path)
	{
		try
		{
			...
			XML.set("ProtoGenesys.AimBot.DisableMouse", gDisableMouse->Custom.bValue);
			...
			XML.set("ProtoGenesys.WallHack.Distances", gPlayerDistances->Custom.bValue);
			XML.set("ProtoGenesys.WallHack.Names", gPlayerNames->Custom.bValue);
	...
	*/
	bool cProfiler::LoadProfile(const std::string& path)
	{
		try
		{
			...
			XML.get_if_present("ProtoGenesys.AimBot.DisableMouse", gDisableMouse->Custom.bValue);
			...
			XML.get_if_present("ProtoGenesys.WallHack.Distances", gPlayerDistances->Custom.bValue);
			XML.get_if_present("ProtoGenesys.WallHack.Names", gPlayerNames->Custom.bValue);
	...
	*/
	void cProfiler::DisableAll()
	{
		...
		gDisableMouse->Custom.bValue = gDisableMouse->Default.bValue;
