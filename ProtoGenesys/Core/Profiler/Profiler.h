...
namespace ProtoGenesys
{
	...
	public:
		...
		std::shared_ptr<sCvar> gSnapLines = std::make_shared<sCvar>("Snaplines", std::vector<std::string>({ "Off", "Top", "Bottom", "Crosshair" }), PLAYER_SNAPLINES_OFF, PLAYER_SNAPLINES_OFF, PLAYER_SNAPLINES_MAX - 1);
		...
		std::shared_ptr<sCvar> gThirdPersonCamera = std::make_shared<sCvar>("Third Person Camera", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gOrbitalVsatAlwaysOn = std::make_shared<sCvar>("Orbital VSAT Always On", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gHardcoreHudOverlay = std::make_shared<sCvar>("Hardcore HUD Overlay", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gDisableEmpOverlay = std::make_shared<sCvar>("Disable EMP Overlay", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		...
		std::shared_ptr<sCvar> gFasterReloading = std::make_shared<sCvar>("Faster Reloading", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gNoFlinch = std::make_shared<sCvar>("No-Flinch", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gOnlyBoneScanPriorities = std::make_shared<sCvar>("Only Bonescan Priorities", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
		std::shared_ptr<sCvar> gOnlyBoneScanRiotShielders = std::make_shared<sCvar>("Only Bonescan Riotshielders", std::vector<std::string>({ "Off", "On" }), FALSE, FALSE, TRUE);
