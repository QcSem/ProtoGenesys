...
namespace ImGui
{
    ...
    // Styles
	IMGUI_API void          StyleTabLabels(ImVec4* colors);

	IMGUI_API void          StyleColorsNeutral(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsNeutralNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsRed(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsRedNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsOrange(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsOrangeNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsYellow(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsYellowNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsGreen(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsGreenNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsBlue(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsBlueNeon(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsPurple(ImGuiStyle* dst = NULL);
	IMGUI_API void          StyleColorsPurpleNeon(ImGuiStyle* dst = NULL);
